...
/**
 * @link https://github.com/LuanRT/googlevideo/blob/main/examples/sabr-shaka-example/scripts/patchShaka.mjs
 */
...
main().catch((e: Error) => {
    console.error('[PatchShaka]', `Failed to patch shaka-player: ${e.message}`);
});
