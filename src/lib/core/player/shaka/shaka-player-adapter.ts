/**
 * @link https://github.com/LuanRT/googlevideo/blob/main/examples/sabr-shaka-example/src/ShakaPlayerAdapter.ts
 */

import { InnertubeProxy, InnertubeState } from '$lib/core/state/innertube';
import {
    type RequestFilter,
    type ResponseFilter,
...
import { type CacheManager, FormatKeyUtils, isGoogleVideoURL, type RequestMetadataManager } from 'googlevideo/utils';
import shaka from 'shaka-player/dist/shaka-player.ui.debug';
import { asMap, createRecoverableError, headersToGenericObject, makeResponse } from './helpers';
...
export class ShakaPlayerAdapter implements SabrPlayerAdapter {
    ...
    private async request(
        ...
        try {
            ...
            const fetchFn = uri.includes('get_drm_license') ? InnertubeProxy.fetch : fetch;
    ...
    public createShakaResponse(args: ShakaResponseArgs): shaka.extern.Response {
        return makeResponse(
            ...
            args.arrayBuffer as BufferSource || new ArrayBuffer(0),
